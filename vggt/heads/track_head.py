...
class TrackHead(nn.Module):
    ...
    def forward(self, aggregated_tokens_list, images, patch_start_idx, query_points=None, query_index=0, iters=None):
        """
        ...
        if query_index < 0 or query_index >= S:
            raise Exception("VGGT: Query index out of bounds")
        ...
        coord_preds, vis_scores, conf_scores = self.tracker(query_points=query_points, query_index=query_index, fmaps=feature_maps, iters=iters)
